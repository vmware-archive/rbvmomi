...
module RbVmomi
  module BasicTypes
    ...
    class ObjectWithProperties < Base
      ...
      def _get_property(_sym)
        raise "unimplemented"
      end

      def _set_property(_sym, _val)
        raise "unimplemented"
      end
    ...
    class DataObject < ObjectWithProperties
      ...
      def pretty_print(q)
        ...
        q.group 2 do
          q.text "("
          q.breakable
          props = @props.sort_by { |k, _v| k.to_s }
    ...
    class ManagedObject < ObjectWithMethods
      ...
      def ==(x)
        ...
        out = (x._connection.instanceUuid == _connection.instanceUuid) if out && x._connection.host
        out
      end
    ...
    class LocalizedMethodFault < DataObject
      ...
      def exception
        RbVmomi::Fault.new(localizedMessage, fault)
      end
    end
